package com.renzpalo.baraka.store;
...
import com.renzpalo.baraka.categories.CategoryProducts;
...
public class Store extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private ImageView ivStoreLogo, ivStoreBanner;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvStoreProducts.setLayoutManager(mLayoutManager);

        productAdapter = new ProductAdapter(this, listProducts, getScreenWidth());

        rvStoreProducts.setAdapter(productAdapter);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(Store.this, HomeActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_provinces) {
            Intent intent = new Intent(Store.this, Provinces.class);
            startActivity(intent);
        } else if (id == R.id.nav_categories) {
            Intent intent = new Intent(Store.this, Categories.class);
            startActivity(intent);
        } else if (id == R.id.nav_wishlist) {
            Intent intent = new Intent(Store.this, WishlistDetails.class);
            startActivity(intent);
        } else if (id == R.id.nav_orders) {
            Intent intent = new Intent(Store.this, OrderHistory.class);
            startActivity(intent);
        } else if (id == R.id.nav_account) {
            Intent intent = new Intent(Store.this, Account.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            Intent intent = new Intent(Store.this, SignInActivity.class);
            startActivity(intent);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (this.menu != null) {
            AppUtility.updateCartCount(Store.this, this.menu);
        }
            ...
            etSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() {
                ...
                public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                    if (i == EditorInfo.IME_ACTION_SEARCH) {
                        ...
                        Intent intent = new Intent(Store.this, SearchProducts.class);
...
////                        }
            ...
            Intent intent = new Intent(Store.this, CartDetails.class);
            startActivity(intent);
        }
    ...
    public void getProductsByStore(String sellerId) {
        if (!NetworkUtility.isNetworkConnected(Store.this)) {
            AppUtility.displayAlertMessage(Store.this, getString(R.string.network_not_connected));
        } else {
            ServiceWrapper serviceWrapper = new ServiceWrapper(null);
            Call<GetProductsByPhp> call = serviceWrapper.getProductsByStorePhpCall("1234", sellerId);
                ...
                public void onResponse(Call<GetProductsByPhp> call, Response<GetProductsByPhp> response) {
                    ...
                    if (response.body() != null && response.isSuccessful()) {
                        if (response.body().getStatus() == 1) {
                            ...
                            Log.e(TAG, "Failed to get seller information." + response.body().getMessage());
    ...
    public void getSellerInformation(String sellerId) {
        if (!NetworkUtility.isNetworkConnected(Store.this)) {

        } else {
            ServiceWrapper serviceWrapper = new ServiceWrapper(null);
            Call<GetSellerInformationPhp> call = serviceWrapper.getSellerInformationPhpCall("1234", sellerId);

            call.enqueue(new Callback<GetSellerInformationPhp>() {
                @Override
                public void onResponse(Call<GetSellerInformationPhp> call, Response<GetSellerInformationPhp> response) {
                    Log.i(TAG, " response: " + response.body().getInformation().toString());
                    ...
                    if (response.body() != null && response.isSuccessful()) {
                        if (response.body().getStatus() == 1) {
                            Glide
                                    ...
                                    .load(response.body().getInformation().getSellerInfo().get(0).getSellerImage())
                                    .into(ivStoreLogo);

                            Glide
                                    .with(getApplicationContext())
                                    .load(response.body().getInformation().getSellerInfo().get(0).getSellerBanner())
                                    .into(ivStoreBanner);

                            tvStoreName.setText(response.body().getInformation().getSellerInfo().get(0).getSellerName());
                        } else {
                            Log.e(TAG, "Failed to get seller information." + response.body().getMessage());
                            // AppUtility.displayMessage(HomeActivity.this, response.body().getMessage());
                        }
                ...
                @Override
                public void onFailure(Call<GetSellerInformationPhp> call, Throwable t) {
                    Log.e(TAG, "failed " + t.toString());
                }
            });
        }
