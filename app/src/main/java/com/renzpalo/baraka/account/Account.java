...
public class Account extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private TextView tvAccountFullname, tvAccountEmail, tvAccountPhone;

    private Button bEditAccount, bAddAddress;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bEditAccount = findViewById(R.id.bEditAccount);
        ...
        userPhone = SharedPreferenceUtility.getInstance().getString(Constant.USER_PHONE);
        ...
        tvAccountFullname.setText(userName);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(Account.this, Provinces.class);
            startActivity(intent);
        } else if (id == R.id.nav_categories) {
            Intent intent = new Intent(Account.this, Categories.class);
            startActivity(intent);
        } else if (id == R.id.nav_wishlist) {
            Intent intent = new Intent(Account.this, WishlistDetails.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(Account.this, SignInActivity.class);
            startActivity(intent);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (this.menu != null) {
            AppUtility.updateCartCount(Account.this, this.menu);
        }
