...
public class SearchProducts extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {

    private String TAG = "SearchProducts";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rvSearchProducts.setLayoutManager(mLayoutManager);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(SearchProducts.this, HomeActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_provinces) {
            Intent intent = new Intent(SearchProducts.this, Provinces.class);
            startActivity(intent);
        } else if (id == R.id.nav_categories) {
            Intent intent = new Intent(SearchProducts.this, Categories.class);
            startActivity(intent);
        } else if (id == R.id.nav_wishlist) {
            Intent intent = new Intent(SearchProducts.this, WishlistDetails.class);
            startActivity(intent);
        } else if (id == R.id.nav_orders) {
            Intent intent = new Intent(SearchProducts.this, OrderHistory.class);
            startActivity(intent);
        } else if (id == R.id.nav_account) {
            Intent intent = new Intent(SearchProducts.this, Account.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            Intent intent = new Intent(SearchProducts.this, SignInActivity.class);
            startActivity(intent);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (this.menu != null) {
            AppUtility.updateCartCount(SearchProducts.this, this.menu);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
                ...
                public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                    if (i == EditorInfo.IME_ACTION_SEARCH) {
                        ...
                        if (null != etSearch.getText().toString().trim() && !etSearch.getText().toString().trim().equals("")) {
                            // Start Intent
                            Intent intent = new Intent(SearchProducts.this, SearchProducts.class);
            ...
            Intent intent = new Intent(SearchProducts.this, CartDetails.class);
            startActivity(intent);
        }
    ...
    public void searchProducts(String searchQuery) {
        if (!NetworkUtility.isNetworkConnected(SearchProducts.this)) {
            AppUtility.displayAlertMessage(SearchProducts.this, getString(R.string.network_not_connected));
        } else {
            ServiceWrapper serviceWrapper = new ServiceWrapper(null);
            Call<SearchProductsPhp> call = serviceWrapper.searchProductsPhpCall("1234", searchQuery);

            call.enqueue(new Callback<SearchProductsPhp>() {
                @Override
                public void onResponse(Call<SearchProductsPhp> call, Response<SearchProductsPhp> response) {
                ...
                @Override
                public void onFailure(Call<SearchProductsPhp> call, Throwable t) {
